          ...
          <div class="col-md-3">
               <div class=" p-2 ml-5 mt-5" style="background-color:white; width:70%">
                    ...
                    <div class="collapse" id="collapseExample1" style="padding:5px">
                         ...
                         <input type="checkbox" id="test2" checked="checked" /> <label for="test2">Classic</label><br>
                         <input type="checkbox" id="test1" /> <label for="test1" >Tribute</label><br>
                         <input type="checkbox" id="test2" checked="checked" /> <label for="test2">Family Drama</label><br>
